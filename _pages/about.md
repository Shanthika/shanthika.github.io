...
Hi!! 
I'm currently an intern at the [VCAI](https://www.mpi-inf.mpg.de/departments/visual-computing-and-artificial-intelligence) lab in [MPI](https://www.mpi-inf.mpg.de/home), Saarland. I'm working learning based Cloth Simulation to improve speed and accuracy. I recently finished my Master's under the guidance of [Dr.Avinash Sharma](https://sites.google.com/site/asharmaresearch/) at the [CVIT](https://cvit.iiit.ac.in/) center in IIIT, Hyderabad. My research interests lie at the intersection of Deep Learning and Geometric Processing.
